        ...
        return runBlocking(Dispatchers.IO) {
            unreadSmsCounter.count(
                UnreadSmsCountFilter(
                    includeNormalMessages = settings.includeNormalMessages,
                    includeSpamMessages = settings.includeSpamMessages,
                    includeArchivedMessages = settings.includeArchivedMessages,
                )
            )
        }
    }
